$(document).ready(function() {
	$('#fullpage').fullpage({
		sectionsColor: ['#f5f5f5', '#f5f5f5', '#f5f5f5', '#f5f5f5'], //控制每个section的背景颜色
		...
		anchors: ['about', 'skill', 'show', 'contact'], //定义锚链接(值不能和页面中任意的id或name相同，尤其是在ie下，定义时不需要加#)  
		...
		navigationTooltips: ["关于我", "技能", "项目", "联系"], //项目导航的 tip
